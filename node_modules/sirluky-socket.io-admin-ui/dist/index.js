...
exports.RedisV4Store = exports.RedisStore = exports.InMemoryStore = exports.instrument = void 0;
...
const debug = (0, debug_1.default)("socket.io-admin");
...
const initAuthenticationMiddleware = (namespace, options) => {
    ...
    if (options.auth === false) {
        ...
        try {
            (0, bcryptjs_1.getRounds)(basicAuth.password);
        }
        catch (e) {
        ...
        namespace.use(async (socket, next) => {
            ...
            if (socket.handshake.auth.username === basicAuth.username) {
                const isMatching = await (0, bcryptjs_1.compare)(socket.handshake.auth.password, basicAuth.password);
                if (isMatching) {
...
Object.defineProperty(exports, "RedisV4Store", { enumerable: true, get: function () { return stores_2.RedisV4Store; } });
