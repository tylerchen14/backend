...
exports.RedisV4Store = exports.RedisStore = exports.InMemoryStore = exports.Store = void 0;
class Store {
}
exports.Store = Store;
...
class RedisStore extends Store {
    ...
    saveSession(sessionId) {
        this.redisClient.set(this.computeKey(sessionId), "1", "EX", "" + this.options.sessionDuration);
    }
}
exports.RedisStore = RedisStore;
class RedisV4Store extends Store {
    constructor(redisClient, options) {
        super();
        this.redisClient = redisClient;
        this.options = Object.assign({
...
exports.RedisV4Store = RedisV4Store;
